...
def main():
    ...
    blotter, pl = trade(blotter, pl, 1, pairs[ETH_USD], pairs)
    blotter, pl = trade(blotter, pl, 2, pairs[ETH_USD], pairs)
    blotter, pl = trade(blotter, pl, -1, pairs[BTC_USD], pairs)

    print(blotter)
    print(pl)

def trade(blotter, pl, qty, pair, pairs):
    ...
    pl = update_pl(pl, pairs.index(pair), qty, price)
    return blotter, pl
